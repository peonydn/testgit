...
?>
					...
					<div class="col-md-9">
						<div class="caption">
							<div class="name"><h3><a href="#"><?php echo $this->_var['goods']['goods_name']; ?></a></h3></div>
							<div class="info">	
								<ul>
                                                                        <div class="price"><?php echo $this->_var['goods']['goods_price']; ?><span><?php echo $this->_var['goods']['market_price']; ?></span></div>
                                                                        <!--<li><?php echo $this->_var['lang']['number']; ?>: <?php echo $this->_var['goods']['goods_number']; ?></li>-->
                                                                        <li><?php echo $this->_var['lang']['subtotal']; ?>:<?php echo $this->_var['goods']['subtotal']; ?></li>
								</ul>
							</div>
							
							<label>Qty: </label> <input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4" class="inputBg" style="text-align:center " onkeydown="showdiv(this)"/>
                                                         
                                                        <input name="submit" type="submit" class="btn btn-default" value="<?php echo $this->_var['lang']['update_cart']; ?>" />
							 
                                                        
                                                        <a class="btn btn-default pull-right " href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)">放入收藏夹</a>
                                                        <hr>
							<a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_to_collect&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>';" class="btn btn-default pull-right">删除</a>
						...
						<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                                                    <tr>
                                                      <td bgcolor="#ffffff">
                                                            ...
                                                            <?php echo $this->_var['lang']['subtotal']; ?>：<?php echo $this->_var['shopping_money']; ?>
...
?>
      ...
      <div class="flowBox">
        <h6><span><?php echo $this->_var['lang']['goods_list']; ?></span><?php if ($this->_var['allow_edit_cart']): ?><a href="flow.php" class="f6 pull-right"><?php echo $this->_var['lang']['modify']; ?></a><?php endif; ?></h6>
...
?>
      ...
      <div class="blank"></div>
      <div class="flowBox">
      <h6><span><?php echo $this->_var['lang']['consignee_info']; ?></span><a href="flow.php?step=consignee" class="f6 pull-right"><?php echo $this->_var['lang']['modify']; ?></a></h6>
      <table width="99%" align="center" border="1" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;" >
            <!--<input type="image"  src="themes/default-php4/images/bnt_subOrder.gif" />-->
