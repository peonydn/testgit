...
<div class="container">
    ...
    <div class=" col-md-9 sidebar breadcrumb">       
        <!--<div class="breadcrumb">-->
         ...
         <?php if ($this->_var['action'] == 'default'): ?>
          ...
          <?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()" style="color:#006bd0;"><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
           ...
           <img src="themes/default-php4/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?>
           </div>
           <br /><br />
          ...
          <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
                  <table width="100%" border="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td>
                      <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/default-php4/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
...
?>
    <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/default-php4/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php else: ?>
  ...
  <?php echo $this->smarty_insert_scripts(array('files'=>'transport.js,utils.js')); ?>
    ...
    <div class="blank"></div>
     <table  class="table table-hover" width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
      <tr align="center">
...
?>
      <tr>
        ...
        <td align="center" bgcolor="#ffffff">
          ...
          <a class="btn btn-default" href="javascript:if (confirm('<?php echo $this->_var['lang']['del_attention']; ?>')) location.href='user.php?act=del_attention&rec_id=<?php echo $this->_var['goods']['rec_id']; ?>'" class="f6"><?php echo $this->_var['lang']['no_attention']; ?></a>
          <?php else: ?>
          <a class="btn btn-default" href="javascript:if (confirm('<?php echo $this->_var['lang']['add_to_attention']; ?>')) location.href='user.php?act=add_to_attention&rec_id=<?php echo $this->_var['goods']['rec_id']; ?>'" class="f6"><?php echo $this->_var['lang']['attention']; ?></a>
          <?php endif; ?>
           <a class="btn btn-default" href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="f6"><?php echo $this->_var['lang']['add_to_cart']; ?></a> 
           <a class="btn btn-default" href="javascript:if (confirm('<?php echo $this->_var['lang']['remove_collection_confirm']; ?>')) location.href='user.php?act=delete_collection&collection_id=<?php echo $this->_var['goods']['rec_id']; ?>'" class="f6"><?php echo $this->_var['lang']['drop']; ?></a>
        </td>
      </tr>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </table>
